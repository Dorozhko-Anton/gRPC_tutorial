 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void GetFeature(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Feature* response, std::function<void(::grpc::Status)>) = 0;
      // response-streaming RPC
      virtual void ListFeatures(::grpc::ClientContext* context, ::Rectangle* request, ::grpc::experimental::ClientReadReactor< ::Feature>* reactor) = 0;
      // request-streaming RPC 
      virtual void RecordRoute(::grpc::ClientContext* context, ::RouteSummary* response, ::grpc::experimental::ClientWriteReactor< ::Point>* reactor) = 0;
      // bidirectional
      virtual void RouteChat(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::RouteNote,::RouteNote>* reactor) = 0;
    };
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void GetFeature(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Feature* response, std::function<void(::grpc::Status)>) override;
      void ListFeatures(::grpc::ClientContext* context, ::Rectangle* request, ::grpc::experimental::ClientReadReactor< ::Feature>* reactor) override;
      void RecordRoute(::grpc::ClientContext* context, ::RouteSummary* response, ::grpc::experimental::ClientWriteReactor< ::Point>* reactor) override;
      void RouteChat(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::RouteNote,::RouteNote>* reactor) override;
     private:
      friend class Stub;
  ...
  class ExperimentalWithCallbackMethod_GetFeature : public BaseClass {
   ...
   public:
    ...
    virtual void GetFeature(::grpc::ServerContext* context, const ::Point* request, ::Feature* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_ListFeatures : public BaseClass {
   ...
   public:
    ...
    virtual ::grpc::experimental::ServerWriteReactor< ::Rectangle, ::Feature>* ListFeatures() {
  ...
  class ExperimentalWithCallbackMethod_RecordRoute : public BaseClass {
   ...
   public:
    ...
    virtual ::grpc::experimental::ServerReadReactor< ::Point, ::RouteSummary>* RecordRoute() {
   ...
   public:
    ExperimentalWithCallbackMethod_RouteChat() {
      ::grpc::Service::experimental().MarkMethodCallback(3,
        new ::grpc::internal::CallbackBidiHandler< ::RouteNote, ::RouteNote>(
    ...
    virtual ::grpc::experimental::ServerBidiReactor< ::RouteNote, ::RouteNote>* RouteChat() {
