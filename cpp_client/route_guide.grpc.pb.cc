...
void RouteGuide::Stub::experimental_async::GetFeature(::grpc::ClientContext* context, const ::Point* request, ::Feature* response, std::function<void(::grpc::Status)> f) {
...
void RouteGuide::Stub::experimental_async::GetFeature(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Feature* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetFeature_, context, request, response, std::move(f));
}
...
void RouteGuide::Stub::experimental_async::ListFeatures(::grpc::ClientContext* context, ::Rectangle* request, ::grpc::experimental::ClientReadReactor< ::Feature>* reactor) {
...
void RouteGuide::Stub::experimental_async::RecordRoute(::grpc::ClientContext* context, ::RouteSummary* response, ::grpc::experimental::ClientWriteReactor< ::Point>* reactor) {
...
void RouteGuide::Stub::experimental_async::RouteChat(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::RouteNote,::RouteNote>* reactor) {
  ::grpc::internal::ClientCallbackReaderWriterFactory< ::RouteNote,::RouteNote>::Create(stub_->channel_.get(), stub_->rpcmethod_RouteChat_, context, reactor);
}
